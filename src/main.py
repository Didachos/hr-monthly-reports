...
# Πλήρης λίστα κωδικών Εργάνης (επίσημη λίστα — Αδειών)
ERGANI_CODE_TO_DESCRIPTION = {
    ...
    "ΑΔΠΠΜ":  "Ειδική παροχή προστασίας της μητρότητας",
    "ΑΔΠΑ":   "Άδεια πατρότητας",
    "ΑΔΦΠ":   "Άδεια φροντίδας παιδιού",
    "ΑΔΓΟΝ":  "Γονική άδεια",
    "ΑΔΦΡΟ":  "Άδεια φροντιστή",
    "ΑΔΑΠΑΒ": "Απουσία από την εργασία για λόγους ανωτέρας βίας",
    "ΑΔΙΥΑ":  "Άδεια για υποβολή σε μεθόδους ιατρικώς υποβοηθούμενης αναπαραγωγής",
    "ΑΔΠΕ":   "Άδεια εξετάσεων προγεννητικού ελέγχου",
    "ΑΔΓΑΜ":  "Άδεια γάμου",
    "ΑΔΣΝΠ":  "Άδεια λόγω σοβαρών νοσημάτων των παιδιών",
    "ΑΔΝΠ":   "Άδεια λόγω νοσηλείας των παιδιών",
    "ΑΔΜΟ":   "Άδεια μονογονεϊκών οικογενειών",
    "ΑΔΠΣΕΤ": "Άδεια παρακολούθησης σχολικής επίδοσης τέκνου",
    "ΑΔΑΠΕΜ": "Άδεια λόγω ασθένειας παιδιού ή άλλου εξαρτώμενου μέλους",
    "ΑΔΑΠΣΚ": "Απουσία από την εργασία λόγω επικείμενου σοβαρού κινδύνου βίας ή παρενόχλησης",
    "ΑΔΑΣ":   "Άδεια ασθένειας (ανυπαίτιο κώλυμα παροχής εργασίας)",
    "ΑΔΑΜΕΑ": "Άδεια απουσίας Α.Μ.Ε.Α.",
    "ΑΔΘΣΥΓ": "Άδεια λόγω θανάτου συγγενούς",
    "ΑΔΑΝΣΠ": "Άδεια ανήλικων σπουδαστών",
    "ΑΔΜΑΑ":  "Άδεια για μεταγγίσεις αίματος και των παραγώγων του ή αιμοκάθαρση",
    "ΑΔΕΚΦ":  "Εκπαιδευτική άδεια για φοιτητές στο Κ.ΑΝ.Ε.Π. - Γ.Σ.Ε.Ε.",
    "ΑΔΣΕΑΑ": "Άδεια λόγω AIDS",
    "ΑΔΕΡΕ":  "Ευέλικτες ρυθμίσεις εργασίας",
    "ΩΑΦΠ":   "Άδεια φροντίδας παιδιού (ΩΡΕΣ)",
    "ΩΑΓΟΝ":  "Γονική άδεια (ΩΡΕΣ)",
    "ΩΑΑΠΑΒ": "Απουσία από την εργασία για λόγους ανωτέρας βίας (ΩΡΕΣ)",
    "ΩΑΕΡΕ":  "Ευέλικτες ρυθμίσεις εργασίας (ΩΡΕΣ)",
    "ΩΑΠΕ":   "Άδεια εξετάσεων προγεννητικού ελέγχου (ΩΡΕΣ)",
    "ΩΑΠΣΕΤ": "Άδεια παρακολούθησης σχολικής επίδοσης τέκνου (ΩΡΕΣ)",
    "ΑΔΑΛ":   "Άδεια Άλλη",
